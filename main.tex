...
\newcommand{\NombreAlumno}{Emanuel Hernández Aguirre}
\soulregister{\NombreAlumno}{1}
% NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyecto}{Sistema de Apoyo a la Generación de Acuerdos Judiciales mediante Inteligencia Artificial Generativa para el PJETAM} 
% Noten los \\ para insertar un ENTER del texto en el encabezado. NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyectoheader}{Sistema de Apoyo a la Generación de Acuerdos Judiciales mediante Inteligencia Artificial Generativa para el PJETAM}
\newcommand{\NombreTSU}{Desarrollo de software multiplataforma}
\newcommand{\UnidadEconomica}{Poder Judicial del Estado de Tamaulipas}
\newcommand{\nasesorempresaria}   {Luis Roberto Flores de la Fuente}
\newcommand{\nasesorinstitucional}{Dr. Said Polanco Martagón}
\newcommand{\Matricula}           {2430117}  %SU MATRICULA
...
El presente documento expone el desarrollo del proyecto de estadía titulado ``Sistema de Apoyo a la Generación de Acuerdos Judiciales mediante Inteligencia Artificial Generativa para el PJETAM'' (SAGAI), llevado a cabo en el Poder Judicial del Estado de Tamaulipas, ubicado en [Boulevard Praxedis Balboa, número 2207 entre las calles López Velarde Y Díaz Mirón, en la Colonia Miguel Hidalgo, Código Postal 87090 en Ciudad Victoria, Tamaulipas]. El objetivo principal de este trabajo consistió en diseñar y programar una plataforma web orientada al desarrollo Frontend para asistir a los secretarios de acuerdos en la redacción técnica de resoluciones legales, buscando optimizar los tiempos operativos del juzgado. Para alcanzar esta meta, la metodología de trabajo se dividió en fases, comenzando con el mapeo de la experiencia de usuario y la creación de prototipos interactivos utilizando la herramienta Figma. Posteriormente, aplicando los conocimientos de ingeniería y programación web adquiridos durante la formación en la Universidad Politécnica de Victoria, se construyó el sistema empleando HTML5 y CSS3 puro para la estructura visual. La interactividad y las peticiones asíncronas se desarrollaron con JavaScript (Vanilla JS), mientras que el procesamiento lógico se apoyó en un servidor construido con FastAPI. A través de este último, se logró la integración con tecnología de reconocimiento óptico de caracteres (OCR) y con la API del modelo de lenguaje de inteligencia artificial Claude. Como resultado, se obtuvo un sistema web responsivo y completamente funcional, en el cual el personal judicial puede cargar documentos físicos escaneados, extraer su texto y recibir un borrador estructurado en ventanas modales dinámicas. En conclusión, el proyecto demostró la viabilidad de incorporar inteligencia artificial generativa en labores legales, logrando agilizar los procesos administrativos y de redacción, manteniendo en todo momento la revisión, validación y el control absoluto del documento en manos de los servidores públicos.
